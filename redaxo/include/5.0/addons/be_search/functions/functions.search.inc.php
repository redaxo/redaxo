...
function rex_a256_extensions_handler($params)
{
  ...
  if($page == 'structure')
  {
    require_once $REX['SRC_PATH'] .'/core/addons/be_search/extensions/extension_search_structure.inc.php';
  ...
  {
    require_once $REX['SRC_PATH'] .'/core/addons/be_search/extensions/extension_search_mpool.inc.php';
