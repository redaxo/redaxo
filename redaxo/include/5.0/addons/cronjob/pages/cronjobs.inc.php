...
if ($func == '')
{
  ...
  $field->setLabel($I18N->msg('cronjob_description'));
  ...
  $select = $field->getSelect();
  $select->setSize(1);
  $select->addOption($I18N->msg('cronjob_execution_beginning'),1);
  $select->addOption($I18N->msg('cronjob_execution_ending'),0);
  if ($func == 'add')
