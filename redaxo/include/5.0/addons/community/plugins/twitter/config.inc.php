...
include $REX['SRC_PATH'] .'/addons/community/plugins/twitter/classes/class.twitter.inc.php';
include $REX['SRC_PATH'] .'/addons/community/plugins/twitter/classes/class.rex_com_twitter.inc.php';
