...
class rex_xform
{
	...
	function rex_xform()
	{
		...
		require_once($REX['SRC_PATH'] .'/core/addons/xform/classes/basic/'.'class.xform.value.abstract.inc.php');
		require_once($REX['SRC_PATH'] .'/core/addons/xform/classes/basic/'.'class.xform.action.abstract.inc.php');
		require_once($REX['SRC_PATH'] .'/core/addons/xform/classes/basic/'.'class.xform.validate.abstract.inc.php');

		$this->objparams = array();
		$this->objparams['object_path'] = $REX['SRC_PATH'] ."/core/addons/xform/classes/";
