...
$REX['ADDON']['xform']['classpaths']['value'] = array($REX['SRC_PATH'] .'/core/addons/xform/classes/value/');
$REX['ADDON']['xform']['classpaths']['validate'] = array($REX['SRC_PATH'] .'/core/addons/xform/classes/validate/');
$REX['ADDON']['xform']['classpaths']['action'] = array($REX['SRC_PATH'] .'/core/addons/xform/classes/action/');

// Basis Klasse rex_xform
include ($REX['SRC_PATH'] .'/core/addons/'.$mypage.'/classes/basic/class.rex_xform.inc.php');
