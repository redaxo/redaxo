...
';
  ...
  if(rex_replace_dynamic_contents($config_file, $content) !== false)
    echo rex_info($REX['I18N']->msg('iresize_config_saved'));
  else
    echo rex_warning($REX['I18N']->msg('iresize_config_not_saved'));
}

if(!is_writable($config_file))
  echo rex_warning($REX['I18N']->msg('iresize_config_not_writable', $config_file));

echo '

<div class="rex-addon-output">

<h2 class="rex-hl2">'. $REX['I18N']->msg('iresize_subpage_config') .'</h2>
      ...
      <div class="rex-form-wrapper">
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_cachefiles">'. $REX['I18N']->msg('iresize_max_cache_files') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_filters">'. $REX['I18N']->msg('iresize_max_filters') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_resizekb">'. $REX['I18N']->msg('iresize_max_resizekb') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="max_resizepixel">'. $REX['I18N']->msg('iresize_max_resizepx') .'</label>
			...
			<div class="rex-form-row rex-form-element-v2">
				<p class="rex-form-text">
					<label for="jpg_quality">'. $REX['I18N']->msg('iresize_jpg_quality') .' [0-100]</label>
