...
require_once($REX['SRC_PATH']. '/core/addons/phpmailer/classes/class.phpmailer.php');
require_once($REX['SRC_PATH']. '/core/addons/phpmailer/classes/class.rex_mailer.inc.php');