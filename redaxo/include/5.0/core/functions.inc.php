...
// ----------------- TIMER
include_once $REX['SRC_PATH']."/core/functions/function_rex_time.inc.php";

// ----------------- REDAXO INCLUDES
// ----- FUNCTIONS
include_once $REX['SRC_PATH'].'/core/functions/function_rex_globals.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_ajax.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_client_cache.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_url.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_extension.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_addons.inc.php';
include_once $REX['SRC_PATH'].'/core/functions/function_rex_plugins.inc.php';
...
// ----- EXTRA CLASSES
// include_once $REX['SRC_PATH'].'/config/classes/class.compat.inc.php';