...
if ($subpage == '')
{
  ...
  echo '
      ...
      <colgroup>
        ...
        <tr>
          ...
          <th class="rex-col-g">'.$REX['I18N']->msg("addon_hprior").'</th>
        </tr>
  	  </thead>
  	  <tbody>';
  ...
  foreach (OOAddon::getRegisteredAddons() as $addon)
  {
    ...
    $moveUp   = '<a href="'. $addonurl .'move=up" class="rex-move-up"><span>'.$REX['I18N']->msg("addon_move_up").'</span></a>';
    $moveDown = '<a href="'. $addonurl .'move=down" class="rex-move-down"><span>'.$REX['I18N']->msg("addon_move_down").'</span></a>';
    ...
    if(OOAddon::isAvailable($addon))
    {
      foreach(OOPlugin::getRegisteredPlugins($addon) as $plugin)
      {
        ...
        $moveUp   = '<a href="'. $pluginurl .'move=up" class="rex-move-up"><span>'.$REX['I18N']->msg("addon_move_up").'</span></a>';
        $moveDown = '<a href="'. $pluginurl .'move=down" class="rex-move-down"><span>'.$REX['I18N']->msg("addon_move_down").'</span></a>';
