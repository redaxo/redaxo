    ...
    <div class="rex-navi-paginate rex-toolbar">
      <div class="rex-toolbar-content">
        <ul class="rex-navi-paginate">
        	<li class="rex-navi-paginate-prev"><a href="<?php echo $this->list->getUrl(array('start' => $this->pager->getCursor($this->pager->getPrevPage()))) ?>" title="<?php echo $this->i18n('list_previous') ?>"><span><?php echo $this->i18n('list_previous') ?></span></a></li>
          <?php for($page = $this->pager->getFirstPage(); $page < $this->pager->getLastPage(); $page++): ?>
            ...
            <li class="rex-navi-paginate-page"><a href="<?php $this->list->getUrl(array('start' => $this->pager->getCursor($page))) ?>"><span><?php echo ($page+1) ?></span></a></li>
          <?php endfor; ?>
