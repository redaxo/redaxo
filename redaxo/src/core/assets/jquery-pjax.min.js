...
"",A(a.requestUrl))),c("pjax:start",[h,a]),c("pjax:send",[h,a]));return f.xhr}function I(a,c){return f(b.extend({url:window.location.href,push:!1,replace:!0,scrollTo:!1},q(a,c)))}function r(a){window.history.replaceState(null,"","#");window.location.replace(a)}function B(a){if((a=a.state)&&a.container){if(u&&J==a.url)return;var c=b(a.container);if(c.length){var e,d=n[a.id];if(f.state){var k=e=f.state.id<a.id?"forward":"back",l=f.state.id,h=c.clone().contents();n[l]=h;"forward"===k?(k=p,h=s):(k=s,
h=p);k.push(l);(l=h.pop())&&delete n[l]}e=b.Event("pjax:popstate",{state:a,direction:e});c.trigger(e);e={id:a.id,url:a.url,container:c,push:!1,fragment:a.fragment,timeout:a.timeout,scrollTo:!1};d?(c.trigger("pjax:start",[null,e]),a.title&&(document.title=a.title),c.html(d),f.state=a,c.trigger("pjax:end",[null,e])):f(e);c[0].offsetHeight}else r(location.href)}u=!1}function K(a){var c=b.isFunction(a.url)?a.url():a.url,e=a.type?a.type.toUpperCase():"GET",d=b("<form>",{method:"GET"===e?"GET":"POST",action:c,
style:"display:none"});"GET"!==e&&"POST"!==e&&d.append(b("<input>",{type:"hidden",name:"_method",value:e.toLowerCase()}));a=a.data;if("string"===typeof a)b.each(a.split("&"),function(a,c){var e=c.split("=");d.append(b("<input>",{type:"hidden",name:e[0],value:e[1]}))});else if("object"===typeof a)for(key in a)d.append(b("<input>",{type:"hidden",name:key,value:a[key]}));b(document.body).append(d);d.submit()}function A(a){return a.replace(/\?_pjax=[^&]+&?/,"?").replace(/_pjax=[^&]+&?/,"").replace(/[\?&]$/,
"")}function t(a){var b=document.createElement("a");b.href=a;return b}function q(a,c){a&&c?c.container=a:c=b.isPlainObject(a)?a:{container:a};c.container&&(c.container=y(c.container));return c}function y(a){a=b(a);if(a.length){if(""!==a.selector&&a.context===document)return a;if(a.attr("id"))return b("#"+a.attr("id"));throw"cant get selector for pjax container!";}throw"no pjax container for "+a.selector;}function v(a){return b.parseHTML(a,document,!0)}function z(a,c,e){var d={};d.url=A(c.getResponseHeader("X-PJAX-URL")||
e.requestUrl);if(/<html/i.test(a)){c=b(v(a.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0]));var f=b(v(a.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0]))}else c=f=b(v(a));if(0===f.length)return d;d.title=c.filter("title").add(c.find("title")).last().text();e.fragment?(a="body"===e.fragment?f:f.filter(e.fragment).add(f.find(e.fragment)).first(),a.length&&(d.contents=a.contents(),d.title||(d.title=a.attr("title")||a.data("title")))):/<html/i.test(a)||(d.contents=f);d.contents&&(d.contents=d.contents.not(function(){return b(this).is("title")}),
d.contents.find("title").remove(),d.scripts=d.contents.filter("script[src]").add(d.contents.find("script[src]")).remove(),d.contents=d.contents.not(d.scripts));d.title&&(d.title=b.trim(d.title));return d}function G(a){if(a){var c=b("script[src]");a.each(function(){var a=this.src;if(!c.filter(function(){return this.src===a}).length){var d=document.createElement("script");d.type=b(this).attr("type");d.src=b(this).attr("src");document.head.appendChild(d)}})}}function H(a,b){n[a]=b;for(p.push(a);s.length;)delete n[s.shift()];
for(;p.length>f.defaults.maxCacheLength;)delete n[p.shift()]}function L(){return b("meta").filter(function(){var a=b(this).attr("http-equiv");return a&&"X-PJAX-VERSION"===a.toUpperCase()}).attr("content")}function C(){b.fn.pjax=E;b.pjax=f;b.pjax.enable=b.noop;b.pjax.disable=D;b.pjax.click=x;b.pjax.submit=F;b.pjax.reload=I;b.pjax.defaults={timeout:650,push:!0,replace:!1,type:"GET",dataType:"html",scrollTo:0,maxCacheLength:20,version:L};b(window).on("popstate.pjax",B)}function D(){b.fn.pjax=function(){return this};
b.pjax=K;b.pjax.enable=C;b.pjax.disable=b.noop;b.pjax.click=b.noop;b.pjax.submit=b.noop;b.pjax.reload=function(){window.location.reload()};b(window).off("popstate.pjax",B)}var u=!0,J=window.location.href,w=window.history.state;w&&w.container&&(f.state=w);"state"in window.history&&(u=!1);var n={},s=[],p=[];0>b.inArray("state",b.event.props)&&b.event.props.push("state");b.support.pjax=window.history&&window.history.pushState&&window.history.replaceState&&!navigator.userAgent.match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]|WebApps\/.+CFNetwork)/);
b.support.pjax?C():D()})(jQuery);
