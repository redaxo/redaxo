...
class rex_sortable_iterator_test extends PHPUnit_Framework_TestCase
{
  ...
  public function testValuesMode()
  {
    ...
    $this->assertEquals(array(1 => 'a', 3 => 'b', 2 => 1, 0 => 2), iterator_to_array($iterator), 'On default the iterator sorts by value');
  }
  ...
  public function testKeysMode()
  {
    ...
    $this->assertEquals(array('a' => 1, 'b' => 3, 1 => 2, 2 => 0), iterator_to_array($iterator), 'In KEYS mode the iterator sorts by keys');
  }
  ...
  public function testCallbackMode()
  {
    ...
    $this->assertEquals(array(0 => 2, 2 => 1, 3 => 'b', 1 => 'a'), iterator_to_array($iterator), 'If the secound parameter is a callback, the iterator sorts by using the function');
  }
}
