...
<nav class="navbar navbar-<?= (isset($this->inverse) && $this->inverse) ? 'inverse' : 'default'; ?><?= (!isset($this->brand) || !$this->brand || $this->brand === '') ? ' rex-navbar-without-brand' : ' rex-navbar-without-brand' ?><?= (isset($this->cssClass) && $this->cssClass != '') ? ' ' . $this->cssClass : ''; ?>">
