    <footer class="rex-global-footer">
        <nav class="rex-nav-footer">
            <ul class="list-inline">
                ...
                <li><a href="<?php echo(rex::getUser()) ? rex_url::backendPage('credits') : 'https://www.redaxo.org/doku/master" target="_blank" rel="noreferrer noopener' ?>"><?php echo rex_i18n::msg('footer_doku'); ?></a></li>
