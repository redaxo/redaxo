...
foreach($this->blocks as $block)
{
	...
	if(!$this->only_ul)
	{
	  echo '<dl class="rex-navi-'.$this->type.'">
	    <dt>';
	  if(isset($headline)) {
	...
	foreach($navigation as $navi) {
	   	echo '<li ';
	   	if(isset($navi["itemClasses"]) && is_array($navi["itemClasses"]) && count($navi["itemClasses"])>0) echo ' class="'.implode(' ',$navi["itemClasses"]).'"';
	   	...
	   	if(isset($navi["href"]) && $navi["href"] != "")
	   	{
	    	...
	    	if(isset($navi["linkClasses"]) && is_array($navi["linkClasses"]) && count($navi["linkClasses"])>0) echo ' class="'.implode(' ',$navi["linkClasses"]).'"';
		...
		if(isset($navi["children"]) && count($navi["children"])>0)
		{
			...
			{
		    	echo '<li ';
		    	if(isset($subnavi["itemClasses"]) && is_array($subnavi["itemClasses"]) && count($subnavi["itemClasses"])>0) echo ' class="'.implode(' ',$subnavi["itemClasses"]).'"';
		    	...
		    	if(isset($subnavi["href"]) && $navi["href"] != "")
		    	{
			    	...
			    	if(isset($subnavi["linkClasses"]) && is_array($subnavi["linkClasses"]) && count($subnavi["itemClasses"])>0) echo ' class="'.implode(' ',$subnavi["linkClasses"]).'"';
