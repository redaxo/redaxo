...
class rex_sql_table
{
    ...
    private function __construct($name, $dbid = 1)
    {
        $this->sql = rex_sql::factory($dbid);
        $this->name = $name;
     ...
     * @return self
     */
    public static function get($name, $dbid = 1)
    {
        return self::getInstance([$dbid,$name], static function ($name, $dbid) {
