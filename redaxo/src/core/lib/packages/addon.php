...
class rex_addon implements rex_addon_interface
{
    ...
    public function loadProperties(bool $force = false)
    {
        ...
        if (null === $cache) {
            ...
            $cache = rex_file::getCache(Path::coreCache(self::PROPERTIES_CACHE_FILE));
        }
            ...
            try {
                ...
                if (!$registeredShutdown) {
                    ...
                    register_shutdown_function(static function () use (&$cache) {
                        ...
                        rex_file::putCache(Path::coreCache(self::PROPERTIES_CACHE_FILE), $cache);
                    });
                }
    ...
    public function clearCache()
    {
        ...
        $cache = rex_file::getCache($path = Path::coreCache(self::PROPERTIES_CACHE_FILE));
        if ($cache) {
