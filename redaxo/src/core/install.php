...
rex_sql_table::get(rex::getTable('user'))
    ...
    ->ensureColumn(new rex_sql_column('status', 'tinyint(1)'))
    ->ensureColumn(new rex_sql_column('admin', 'tinyint(1)', false, '0'))
    ->ensureColumn(new rex_sql_column('language', 'varchar(255)', true))
    ->ensureColumn(new rex_sql_column('startpage', 'varchar(255)', true))
    ...
    ->ensureColumn(new rex_sql_column('password_change_required', 'tinyint(1)', false, '0'))
