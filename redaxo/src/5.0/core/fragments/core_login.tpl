...
$js = '';
if ($this->rex_user_loginmessage != '')
{
  echo rex_warning($this->rex_user_loginmessage)."\n";
  $js = '
    ...
    <div class="rex-form-wrapper">
    	...
    	<div class="rex-form-row">
		    <p class="rex-form-col-a rex-form-text">
      		...
      		<input type="text" value="'.htmlspecialchars($this->rex_user_login).'" id="rex-form-login" name="rex_user_login" />
    		</p>
    	</div>
    	<div class="rex-form-row">
