...
h = height      (Skalieren in der H�he)<br />
c = crop        (Bildausschnitt herausschneiden)<br />
a = automatic   (Skalieren anhand der l�ngsten Seite des Bildes)
</p>
...
<br /><br />
Skaliere das Bild auf eine H�he von 150px. Die Proportionen des Bildes werden beibehalten.<br />
<b><?php echo $REX["FRONTEND_FILE"]; ?>?rex_resize=150h__imagefile</b>

<br /><br />
Skaliere das Bild anhand der l�ngsten Seite, diese auf eine L�nge von 200px. Die Proportionen des Bildes werden beibehalten.<br />
<b><?php echo $REX["FRONTEND_FILE"]; ?>?rex_resize=200a__imagefile</b>

<br /><br />
Skaliere das Bild auf eine Breite von 100px und eine H�he von 200px. Ggf. wird das Bild dadurch verzehrt..<br />
...
<br /><br />
Wende die Filter blur und sepia auf das Bild an. Zugleich wird das Bild an der l�ngsten Seite auf 200px l�nge skaliert. Die Proportionen des Bildes werden beibehalten.<br />
