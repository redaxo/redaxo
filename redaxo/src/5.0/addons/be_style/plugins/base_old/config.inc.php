...
if($REX["REDAXO"])
{
  ...
  {
  	$params["subject"] = '
  <link rel="stylesheet" type="text/css" href="'. rex_path::pluginAssets('be_style', 'base_old', 'css_import.css', true) .'" media="screen, projection, print" />
  <!--[if lte IE 7]>
    <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'base_old', 'css_ie_lte_7.css', true) .'" type="text/css" media="screen, projection, print" />
  <![endif]-->

  <!--[if IE 7]>
    <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'base_old', 'css_ie_7.css', true) .'" type="text/css" media="screen, projection, print" />
  <![endif]-->

  <!--[if lte IE 6]>
    <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'base_old', 'css_ie_lte_6.css', true) .'" type="text/css" media="screen, projection, print" />
  <![endif]-->

  <!-- jQuery immer nach den Stylesheets! -->
  <script src="'. rex_path::pluginAssets('be_style', 'base_old', 'jquery.min.js', true) .'" type="text/javascript"></script>
  <script src="'. rex_path::pluginAssets('be_style', 'base_old', 'standard.js', true) .'" type="text/javascript"></script>
