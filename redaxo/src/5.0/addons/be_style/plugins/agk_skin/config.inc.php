...
if($REX["REDAXO"])
{
	...
	{
	  $params["subject"] .= '
    <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'agk_skin', 'css_main.css', true) .'" type="text/css" media="screen, projection, print" />
	  <!--[if lte IE 7]>
	      <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'agk_skin', 'css_ie_lte_7.css', true) .'" type="text/css" media="screen, projection, print" />
	    <![endif]-->
	    <!--[if lte IE 6]>
	      <link rel="stylesheet" href="'. rex_path::pluginAssets('be_style', 'agk_skin', 'css_ie_lte_6.css', true) .'" type="text/css" media="screen, projection, print" />
	    <![endif]-->';
