...
if ($exportfilename == '')
  $exportfilename = strtolower($_SERVER['HTTP_HOST']).'_rex'.rex_core::getProperty('version').rex_core::getProperty('subversion').rex_core::getProperty('minorversion').'_'.date("Ymd");
