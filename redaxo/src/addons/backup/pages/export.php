...
foreach ($tables as $table) {
    ...
    if ($table !== rex::getTable('user') && $table !== rex::getTable('user_session') && str_starts_with($table, rex::getTablePrefix()) && !str_starts_with($table, rex::getTablePrefix() . rex::getTempPrefix())) {
