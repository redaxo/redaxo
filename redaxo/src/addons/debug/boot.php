...
if (rex::getConsole()) {
    rex_extension::register(rex_extension_point_console_shutdown::NAME, static function (rex_extension_point $extensionPoint) use ($shutdownFn) {
        $shutdownFn();

        assert($extensionPoint instanceof rex_extension_point_console_shutdown);
