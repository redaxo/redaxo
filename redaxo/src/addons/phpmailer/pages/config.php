...
$n['field'] = '<input class="form-control" id="phpmailer-testadress" type="text" name="settings[test_address]" placeholder="name@example.tld" value="' . $this->getConfig('test_address') . '" />';
$formElements[] = $n;
