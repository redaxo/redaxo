...
if (is_dir(rex_mailer::logFolder())) {
    $n = [];
    $n['field'] = '<a href="' . rex_url::currentBackendPage(['btn_delete_archive' => '1']) . '" data-confirm="' . $addon->i18n('archive_delete_confirm') . '" class="btn btn-danger pull-right">' . $addon->i18n('archive_delete') . '</a>';
    $formElements[] = $n;
}
