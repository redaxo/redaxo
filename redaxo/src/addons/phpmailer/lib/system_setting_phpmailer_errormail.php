...
class rex_system_setting_phpmailer_errormail extends rex_system_setting
{
    ...
    public function getField()
    {
        ...
        $select->addOption(rex_i18n::msg('phpmailer_errormail_6hrs'), 21600);
        $select->addOption(rex_i18n::msg('phpmailer_errormail_12hrs'), 43200);
        $select->addOption(rex_i18n::msg('phpmailer_errormail_24hrs'), 86400);
