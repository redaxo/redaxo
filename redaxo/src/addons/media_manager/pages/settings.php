...
if ($func == 'update') {
    ...
    $myaddon->setConfig($config);
    rex_media_manager::deleteCache();
    echo rex_view::info($myaddon->i18n('config_saved'));
}
...
$n['left'] = '<input id="rex-js-rating-source-jpg-quality" type="range" min="0" max="100" step="1" value="' . rex_escape($myaddon->getConfig('jpg_quality')) . '" />';
$n['field'] = '<input class="form-control" id="rex-js-rating-text-jpg-quality" type="text" name="settings[jpg_quality]" value="' . rex_escape($myaddon->getConfig('jpg_quality')) . '" />';
$inputGroups[] = $n;
...
$n = [];
$n['label'] = '<label for="rex-js-rating-text-jpg-quality">' . $myaddon->i18n('jpg_quality') . '</label>';
$n['field'] = $inputGroup;
$formElements[] = $n;
...
$n = [];
$n['class'] = 'rex-range-input-group';
$n['left'] = '<input id="rex-js-rating-source-webp-quality" type="range" min="0" max="100" step="1" value="' . rex_escape($myaddon->getConfig('webp_quality')) . '" />';
$n['field'] = '<input class="form-control" id="rex-js-rating-text-webp-quality" type="text" name="settings[webp_quality]" value="' . rex_escape($myaddon->getConfig('webp_quality')) . '" />';
$inputGroups[] = $n;
...
$n = [];
$n['label'] = '<label for="rex-js-rating-text-webp-quality">' . $myaddon->i18n('webp_quality') . '</label>';
$n['field'] = $inputGroup;
$formElements[] = $n;
...
$n = [];
$n['class'] = 'rex-range-input-group';
$n['left'] = '<input id="rex-js-rating-source-png-compression" type="range" min="0" max="9" step="1" value="' . rex_escape($myaddon->getConfig('png_compression')) . '" />';
$n['field'] = '<input class="form-control" id="rex-js-rating-text-png-compression" type="text" name="settings[png_compression]" value="' . rex_escape($myaddon->getConfig('png_compression')) . '" />';
$inputGroups[] = $n;
...
$n = [];
$n['label'] = '<label for="rex-js-rating-text-png-compression">' . $myaddon->i18n('png_compression') . '</label>';
$n['field'] = $inputGroup;
$n['note'] = $myaddon->i18n('png_compression_note');
$formElements[] = $n;
...
$select->setSelected($myaddon->getConfig('interlace', ['jpg']));

$n = [];
$n['label'] = '<label for="rex-media-manager-interlace">' . $myaddon->i18n('interlace') . '</label>';
$n['field'] = $select->get();
$formElements[] = $n;
...
$fragment->setVar('title', $myaddon->i18n('subpage_config'), false);
