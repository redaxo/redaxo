...
require_once __DIR__ . '/functions/function_rex_client_cache.php';
require_once __DIR__ . '/functions/function_rex_extension.php';
require_once __DIR__ . '/functions/function_rex_file.php';
require_once __DIR__ . '/functions/function_rex_lang.php';
require_once __DIR__ . '/functions/function_rex_mediapool.php';
require_once __DIR__ . '/functions/function_rex_other.php';
require_once __DIR__ . '/functions/function_rex_content.php';
