...
INSERT INTO `rex_config` VALUES
  (1,'rex-core','package-config','{\"be_dashboard\":{\"install\":false,\"status\":false,\"plugins\":{\"rss_reader\":{\"install\":false,\"status\":false},\"userinfo\":{\"install\":false,\"status\":false},\"version_checker\":{\"install\":false,\"status\":false}}},\"be_search\":{\"install\":true,\"status\":true},\"be_style\":{\"install\":true,\"status\":true,\"plugins\":{\"agk_skin\":{\"install\":false,\"status\":false},\"redaxo\":{\"install\":true,\"status\":true}}},\"compat\":{\"install\":false,\"status\":false,\"plugins\":{\"3.x\":{\"install\":false,\"status\":false},\"4.x\":{\"install\":false,\"status\":false}}},\"cronjob\":{\"install\":false,\"status\":false,\"plugins\":{\"article_status\":{\"install\":false,\"status\":false},\"optimize_tables\":{\"install\":false,\"status\":false}}},\"debug\":{\"install\":false,\"status\":false},\"developer\":{\"install\":false,\"status\":false},\"import_export\":{\"install\":true,\"status\":true},\"install\":{\"install\":true,\"status\":true,\"plugins\":{\"core\":{\"install\":true,\"status\":true},\"packages\":{\"install\":true,\"status\":true}}},\"media_manager\":{\"install\":true,\"status\":true},\"mediapool\":{\"install\":true,\"status\":true},\"metainfo\":{\"install\":true,\"status\":true},\"modules\":{\"install\":true,\"status\":true},\"oodb\":{\"install\":false,\"status\":false},\"phpmailer\":{\"install\":false,\"status\":false},\"structure\":{\"install\":true,\"status\":true,\"plugins\":{\"content\":{\"install\":true,\"status\":true},\"linkmap\":{\"install\":true,\"status\":true},\"version\":{\"install\":false,\"status\":false}}},\"templates\":{\"install\":true,\"status\":true},\"tests\":{\"install\":false,\"status\":false},\"textile\":{\"install\":true,\"status\":true},\"url_rewrite\":{\"install\":false,\"status\":false},\"users\":{\"install\":true,\"status\":true}}'),
  (2,'rex-core','package-order','[\"users\",\"textile\",\"tests\",\"modules\",\"templates\",\"mediapool\",\"structure\",\"structure\\/content\",\"structure\\/linkmap\",\"import_export\",\"metainfo\",\"be_search\",\"be_style\",\"be_style\\/agk_skin\",\"media_manager\",\"be_style\\/redaxo\",\"install\\/core\",\"install\\/packages\",\"install\"]');
