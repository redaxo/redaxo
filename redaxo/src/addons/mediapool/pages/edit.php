...
$mediaForm->setTitle(rex_i18n::msg('pool_file_edit'));
$mediaForm->setButtonTitle(rex_i18n::msg('pool_file_edit'));
...
$mediaForm->addField(
    [
        'label' => '',
        'field' => '<input type="hidden" name="media_method" value="edit_file">',
    ]
);
...
if ('' != $openerInputField) {
    $mediaForm->addSubmit(
        ...
        ).'"'.rex::getAccesskey(rex_i18n::msg('save_and_close_tooltip'), 'save').'>'.rex_i18n::msg(
            'pool_file_upload_get'
        ).'</button>'
    );
}
