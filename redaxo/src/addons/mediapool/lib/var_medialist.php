    ...
    public static function getWidget($id, $name, $value, array $args = [])
    {
        ...
        <div id="rex-widget-medialist-' . $id . '" class="rex-widget' . $wdgtClass . '">
            ...
            <span class="rex-button-vgroup">
                <a href="#" class="rex-button btn btn-primary" onclick="moveREXMedialist(' . $id . ',\'top\');return false;" title="' . rex_i18n::msg('var_medialist_move_top') . '"><span class="rex-icon rex-icon-top"></span></a>
                <a href="#" class="rex-button btn btn-primary" onclick="moveREXMedialist(' . $id . ',\'up\');return false;" title="' . rex_i18n::msg('var_medialist_move_up') . '"><span class="rex-icon rex-icon-up"></span></a>
                <a href="#" class="rex-button btn btn-primary" onclick="moveREXMedialist(' . $id . ',\'down\');return false;" title="' . rex_i18n::msg('var_medialist_move_down') . '"><span class="rex-icon rex-icon-down"></span></a>
                <a href="#" class="rex-button btn btn-primary" onclick="moveREXMedialist(' . $id . ',\'bottom\');return false;" title="' . rex_i18n::msg('var_medialist_move_bottom') . '"><span class="rex-icon rex-icon-bottom"></span></a>
            </span>
