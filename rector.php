...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(RenameClassRector::class, [
        ...
        'rex_linkmap_article_list_renderer' => Content\Linkmap\AbstractArticleListRenderer::class,
        'rex_linkmap_category_tree' => Content\Linkmap\CategoryTree::class,
        'rex_linkmap_tree_renderer' => Content\Linkmap\AbstractCategoryTreeRenderer::class,
