...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(RenameClassRector::class, [
        ...
        'rex_api_article_status' => Content\ApiFunction\ArticleStatus::class,
        ...
        'rex_api_category_status' => Content\ApiFunction\CategoryStatus::class,
        ...
        'rex_api_content_slice_status' => Content\ApiFunction\ArticleSliceStatus::class,
