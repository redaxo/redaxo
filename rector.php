...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(RenameClassRector::class, [
        ...
        rex_dir::class => Filesystem\Dir::class,
        rex_file::class => Filesystem\File::class,
        rex_finder::class => Filesystem\Finder::class,
        rex_form_base::class => Form\AbstractForm::class,
        rex_form::class => Form\Form::class,
        rex_config_form::class => Form\ConfigForm::class,
        rex_form_element::class => Form\Field\BaseField::class,
        rex_form_options_element::class => Form\Field\AbstractOptionField::class,
        rex_form_checkbox_element::class => Form\Field\CheckboxField::class,
        rex_form_radio_element::class => Form\Field\RadioField::class,
        rex_form_container_element::class => Form\Field\ContainerField::class,
        rex_form_control_element::class => Form\Field\ControlField::class,
        rex_form_select_element::class => Form\Field\SelectField::class,
        rex_form_prio_element::class => Form\Field\PriorityField::class,
        rex_form_perm_select_element::class => Form\Field\PermissionSelectField::class,
        rex_form_raw_element::class => Form\Field\RawField::class,
        rex_i18n::class => Translation\I18n::class,
        rex_path::class => Filesystem\Path::class,
        rex_path_default_provider::class => Filesystem\DefaultPathProvider::class,
        rex_sql::class => Database\Sql::class,
        rex_sql_column::class => Database\Column::class,
        rex_sql_foreign_key::class => Database\ForeignKey::class,
        rex_sql_index::class => Database\Index::class,
        rex_sql_schema_dumper::class => Database\SchemaDumper::class,
        rex_sql_table::class => Database\Table::class,
        rex_sql_util::class => Database\Util::class,
        rex_validator::class => Validator\Validator::class,
        rex_validation_rule::class => Validator\ValidationRule::class,
    ])
