...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(RenameClassRector::class, [
        ...
        'rex_api_package' => Addon\Api\AddonApi::class,
        'rex_api_article2category' => Content\Api\ArticleToCategoryApi::class,
        'rex_api_article2startarticle' => Content\Api\ArticleToStartArticleApi::class,
        'rex_api_article_add' => Content\Api\ArticleAddApi::class,
        'rex_api_article_copy' => Content\Api\ArticleCopyApi::class,
        'rex_api_article_delete' => Content\Api\ArticleDeleteApi::class,
        'rex_api_article_edit' => Content\Api\ArticleEditApi::class,
        'rex_api_article_move' => Content\Api\ArticleMoveApi::class,
        'rex_api_article_status' => Content\Api\ArticleStatusApi::class,
        'rex_api_category2article' => Content\Api\CategoryToArticleApi::class,
        'rex_api_category_add' => Content\Api\CategoryAddApi::class,
        'rex_api_category_delete' => Content\Api\CategoryDeleteApi::class,
        'rex_api_category_edit' => Content\Api\CategoryEditApi::class,
        'rex_api_category_move' => Content\Api\CategoryMoveApi::class,
        'rex_api_category_status' => Content\Api\CategoryStatusApi::class,
        'rex_api_content_copy' => Content\Api\ContentCopyApi::class,
        'rex_api_content_move_slice' => Content\Api\ArticleSliceMoveApi::class,
        'rex_api_content_slice_status' => Content\Api\ArticleSliceStatusApi::class,
        'rex_api_has_user_session' => Security\Api\UserHasSessionApi::class,
        'rex_api_user_impersonate' => Security\Api\UserImpersonateApi::class,
        'rex_api_user_remove_auth_method' => Security\Api\UserRemoveAuthMethodApi::class,
        'rex_api_user_remove_session' => Security\Api\UserRemoveSessionApi::class,
