...
final class ErrorHandler
{
    ...
    private static function renderWhoops(Throwable $exception): array
    {
        ...
        $errPage = str_replace(
            ...
            '<ul class="search-for-help">
                            <li>
                                <a rel="noopener noreferrer" target="_blank" href="https://redaxo.org/doku/main" title="Search for help in the REDAXO Docs.">
        ...
        if ($markdownReport) {
            $errPageMarkdownBtn = preg_replace(
                ...
                '$0<button class="rightButton clipboard" data-clipboard-text="' . escape($markdownReport) . '" title="Copy exception details and system report as markdown to clipboard">COPY MARKDOWN</button>',
                $errPage,
            );
